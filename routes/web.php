...
Route::get('membersDetail/{id}',[memberController::class,"showMembers"]);
Route::get('edit/{id}',[ProductController::class,"showEdit"]);
Route::get('memberEdit/{id}',[memberController::class,"memberEdit"]);
Route::put('update',[ProductController::class,"updateProduct"])->name('update');
Route::put('membersUpdate',[memberController::class,"membersUpdate"])->name('membersUpdate');
